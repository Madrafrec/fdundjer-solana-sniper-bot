...
import { CHECK_IF_BURNED, CHECK_IF_FREEZABLE, CHECK_IF_MINT_IS_RENOUNCED, CHECK_IF_MUTABLE, CHECK_IF_SOCIALS, CHECK_HOLDERS_COUNT, CHECK_TOP_HOLDERS_DISTRIBUTION, logger } from '../helpers/constants';export interface Filter {
